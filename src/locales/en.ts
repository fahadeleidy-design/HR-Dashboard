export const enTranslations = {
  ...
  travel: {
    ...
    purpose: 'Purpose',
    purposePlaceholder: 'Purpose of travel...',
    ...
    flightDetailsPlaceholder: 'Flight number, airline, departure time...',
    hotelDetails: 'Hotel Details',
    hotelDetailsPlaceholder: 'Hotel name, address, booking reference...',
    transportationDetails: 'Transportation Details',
    perDiem: 'Per Diem',
    perDiemRate: 'Per Diem Rate',
    travelAdvance: 'Travel Advance',
    advancePayment: 'Advance Payment',
    advancePaymentNote: 'Amount to be paid in advance',
    ...
    rentalCarNeeded: 'Rental Car Needed',
    rentalCarDetails: 'Rental Car Details',
    rentalCarPlaceholder: 'Rental company, car type, pickup location...',
    financialEmergencyInfo: 'Financial & Emergency Information',
    travelInsurance: 'Travel Insurance',
    insurancePlaceholder: 'Insurance policy number',
    emergencyContactName: 'Emergency Contact Name',
    emergencyContactPhone: 'Emergency Contact Phone',
    compliancePermissions: 'Compliance & Permissions',
    requiresExitReentry: 'Requires Exit-Reentry Permit (Expats)',
    visaRequired: 'Destination Visa Required',
    exitReentryNote: 'Exit-reentry permits required for expat employees leaving Saudi Arabia',
  ...
  expenses: {
    ...
    submitExpenseDesc: 'Submit a new expense for reimbursement',
    employee: 'Employee',
    selectEmployee: 'Select Employee',
    ...
    description: 'Description',
    descriptionPlaceholder: 'Provide details about the expense...',
    ...
    fileTypesExpense: 'PDF, PNG, JPG up to 10MB',
    fileSizeError: 'File size must be less than 10MB',
    cancel: 'Cancel',
    submitting: 'Submitting...',
    submitClaim: 'Submit Claim',
    pleaseUploadReceipt: 'Please upload an invoice/receipt',
    failedToCreate: 'Failed to create expense claim. Please try again.',
    meals: 'Meals',
    fuel: 'Fuel',
  ...
  visas: {
    ...
    newRequestTitle: 'New Visa/Work Permit Request',
    newRequestDescription: 'Submit a new visa or work permit request',
    activeWorkVisas: 'Active Work Visas',
    used: 'Used',
    expired: 'Expired',
    activeIqamas: 'Active Iqamas',
    pendingRequests: 'Pending Requests',
    visaQuota: 'Visa Quota',
    available: 'Available',
    requestType: 'Request Type',
    newWorkVisa: 'New Work Visa',
    iqamaIssuance: 'Iqama Issuance',
    iqamaRenewal: 'Iqama Renewal',
    iqamaTransfer: 'Iqama Transfer',
    professionChange: 'Profession Change',
    dependentVisa: 'Dependent Visa',
    selectEmployee: 'Select Employee',
    employeeCandidateName: 'Employee/Candidate Name',
    fullNameAsPerPassport: 'Full name as per passport',
    nationality: 'Nationality',
    nationalityPlaceholder: 'e.g., India, Pakistan, Egypt',
    passportNumber: 'Passport Number',
    passportExpiryDate: 'Passport Expiry Date',
    molProfessionCode: 'Saudi MOL Profession Code',
    selectProfession: 'Select Profession',
    molProfessionNote: 'Select official MOL profession code for visa/iqama',
    jobTitle: 'Job Title',
    proposedSalarySar: 'Proposed Salary (SAR)',
    minimumAsPerMol: 'Minimum as per MOL requirements',
    ...
    molQuotaInfo: 'MOL & Quota Information',
    molQuotaNote: 'Ensure the profession code matches MOL requirements and check available quota before submission. Visa processing typically takes 3-5 business days after MOL approval.',
    availableQuota: 'Available Quota',
    positions: 'positions',
    cancel: 'Cancel',
    createVisaRequest: 'Create Visa Request',
    creating: 'Creating...',
    failedToCreate: 'Failed to create visa request. Please try again.',
    tabVisas: 'Work Visas',
    tabIqamas: 'Residence Permits (Iqama)',
    ...
    filterUnderRenewal: 'Under Renewal',
    refresh: 'Refresh',
    type: 'Type',
    status: 'Status',
    cost: 'Cost',
    actions: 'Actions',
    noWorkVisasFound: 'No work visas found. Click "New Request" to add one.',
    sar: 'SAR',
    ...
    noIqamasFound: 'No residence permits (iqamas) found.',
    expiredLabel: 'EXPIRED',
    daysUnit: 'days',
    na: 'N/A',
    requestDate: 'Request Date',
    noRequestsFound: 'No visa requests found.',
    quotaSummary: 'Visa Quota Summary',
    totalAllocated: 'Total Allocated',
    quotaUsed: 'Used',
    quotaAvailable: 'Available',
    quotaType: 'Quota Type',
    totalQuota: 'Total Quota',
    noQuotasFound: 'No quota information available for',
    general: 'General',
    all: 'All',
    statusActive: 'Active',
    statusUsed: 'Used',
    ...
    statusUnderRenewal: 'Under Renewal',
    requestTypeNewVisa: 'New Visa',
    requestTypeIqamaIssuance: 'Iqama Issuance',
    requestTypeIqamaRenewal: 'Iqama Renewal',
    requestTypeIqamaTransfer: 'Iqama Transfer',
    requestTypeProfessionChange: 'Profession Change',
    requestTypeDependentVisa: 'Dependent Visa',
  ...
  advances: {
    ...
    newAdvance: 'New Advance Request',
    ...
    progress: 'Progress',
    recovered: 'recovered',
    fullDeduction: 'Full deduction',
    advancePolicy: 'Advance Policy',
    policyMaxAdvance: 'Maximum advance: Full monthly salary',
    policyDeduction: "Deduction: Full amount from next month's salary",
    policyOneActive: 'Only one active advance allowed at a time',
    policyNoLoan: 'Cannot request advance while an active loan exists',
    eligibilityTitle: 'Advance Eligibility',
    ...
    deductionNote: "Full amount will be deducted from next month's salary",
    notes: 'Notes',
    cancel: 'Cancel',
    ...
    advanceExceedsSalary: 'Advance amount exceeds monthly salary',
    cannotCreateAdvance: 'Cannot create advance',
    advanceUpdatedSuccess: 'Advance updated successfully!',
    advanceCreatedSuccess: 'Advance request created successfully!',
    advanceDeleteConfirm: 'Are you sure you want to delete this advance?',
    advanceDeletedSuccess: 'Advance deleted successfully!',
    advanceApprovedSuccess: 'Advance approved successfully!',
    advanceRejectedSuccess: 'Advance rejected!',
    failedToSave: 'Failed to save advance',
    failedToDelete: 'Failed to delete advance',
    failedToApprove: 'Failed to approve advance',
    failedToReject: 'Failed to reject advance',
  },
  ...
  loans: {
    ...
    policyMaxLoan: 'Maximum loan: 50% of End of Service benefits',
    policyMaxRepayment: 'Maximum repayment period: 6 months',
    policyEqualInstallments: 'Equal monthly installments',
    policyNoAdvance: 'Cannot request loan while an active advance exists',
    policyOnePerYear: 'Only one loan request per calendar year',
    employee: 'Employee',
    loadingEmployees: 'Loading employees...',
    selfServiceNote: 'You can only create loan requests for yourself',
    loanEligibility: 'Loan Eligibility',
    maxLoanAmount: 'Max Loan Amount',
    outstandingLoansLabel: 'Outstanding Loans',
    outstandingAdvancesLabel: 'Outstanding Advances',
    loansThisYear: 'Loans This Year',
    ...
    pleaseSelectEmployee: 'Please select an employee',
    installmentsBetween1And6: 'Number of installments must be between 1 and 6 months',
    loanExceedsAvailable: 'Loan amount exceeds available loan amount',
    loanUpdatedSuccess: 'Loan updated successfully!',
    loanCreatedSuccess: 'Loan request created successfully!',
    failedToSave: 'Failed to save loan',
    loanDeleteConfirm: 'Are you sure you want to delete this loan?',
    loanDeletedSuccess: 'Loan deleted successfully!',
    failedToDelete: 'Failed to delete loan',
    loanStatusUpdated: 'Loan status updated!',
    failedToUpdateStatus: 'Failed to update loan status',
  },
  ...
  endOfService: {
    ...
    calculateTitle: 'End of Service Calculator',
    selectEmployee: 'Select Employee',
    ...
    noEosBenefitsTitle: 'No End of Service Benefits',
    noEosLessThan2Years: 'No End of Service Benefits - Service Period Less Than 2 Years',
    noEosLessThan2YearsDesc: 'According to Saudi Labor Law Article 84, employees with indefinite (unlimited) contracts must complete at least 2 full years of service to be eligible for end-of-service benefits.',
    noEosForCause: 'According to Saudi Labor Law, employees terminated for cause or during probation period are not entitled to end-of-service benefits.',
    financialSummary: 'Financial Summary',
    grossBenefit: 'Gross Benefit',
    outstandingLoans: 'Outstanding Loans',
    outstandingAdvances: 'Outstanding Advances',
    netBenefit: 'Net Benefit',
    saveCalculation: 'Save Calculation',
    calculationSavedSuccess: 'Calculation saved successfully!',
    errorSavingCalculation: 'Error saving calculation',
    ...
    retirementDesc: 'Employee reached retirement age (60+)',
    deathReason: 'Death',
    deathDesc: 'Employee deceased',
    disabilityReason: 'Disability',
    disabilityDesc: 'Employee became disabled',
    employerTermination: 'Employer Termination',
    employerTerminationDesc: 'Terminated by employer without cause',
    mutualAgreement: 'Mutual Agreement',
    mutualAgreementDesc: 'Both parties agreed to terminate',
    femaleMarriage: 'Female Marriage',
    femaleMarriageDesc: 'Female employee married (within 6 months)',
    contractCompletion: 'Contract Completion',
    contractCompletionDesc: 'Limited term contract completed',
    employeeResignation: 'Employee Resignation',
    employeeResignationDesc: 'Employee voluntarily resigned',
    terminationForCause: 'Termination for Cause',
    terminationForCauseDesc: 'Terminated for disciplinary reasons (No benefits)',
    probationPeriod: 'Probation Period',
    probationPeriodDesc: 'Terminated during probation (No benefits)',
    lawSummaryTitle: 'Saudi Labor Law - End of Service Benefits Summary:',
    lawUnlimited: 'Unlimited Contracts: Less than 2 years = No benefits | 2-5 years = Half month/year | 5+ years = Half month for first 5 years, full month thereafter',
    lawLimited: 'Limited Contracts: Full benefits if employer terminates | Half benefits if employee resigns',
    lawFullBenefits: 'Full Benefits: Retirement, death, disability, employer termination, mutual agreement, female marriage (within 6 months)',
    lawDeductions: 'Deductions: Outstanding loans and salary advances are automatically deducted from final settlement',
  },
  ...
  govSubscriptions: {
    ...
    subscriptionTypePlaceholder: 'Basic, Premium, Enterprise, etc.',
    basic: 'Basic',
    premium: 'Premium',
    ...
    expiringSoon: 'Expiring Soon',
    searchPlaceholder: 'Search by platform, account number...',
    account: 'Account',
    quickSelectPlatforms: 'Quick Select Common Platforms:',
  ...
  documents: {
    ...
    fileTypes: 'PDF, DOC, DOCX, JPG, PNG (max 10MB)',
    uploading: 'Uploading...',
  ...
  governmentalDocs: {
    ...
    chamberOfCommerce: 'Chamber of Commerce Membership',
    ...
    laborOfficeRegistration: 'Labor Office Registration',
    gosiRegistration: 'GOSI Registration',
    other: 'Other',
    documentNameEn: 'Document Name (English)',
    documentNameAr: 'Document Name (Arabic)',
    annualCostSar: 'Annual Cost (SAR)',
    renewalPeriodMonths: 'Renewal Period (Months)',
    ...
    documentDeleteConfirm: 'Are you sure you want to delete this document?',
