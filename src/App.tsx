...
const EmployeePayrollReport = lazy(() => import('./pages/EmployeePayrollReport').then(m => ({ default: m.EmployeePayrollReport })));
              ...
              <ErrorBoundary>
                <Suspense fallback={<PageLoadingFallback />}>
                  <Routes>
                    ...
                    <Route path="/employee-payroll-report" element={<ProtectedPage allowedRoles={['super_admin', 'hr', 'finance', 'admin']}><EmployeePayrollReport /></ProtectedPage>} />
